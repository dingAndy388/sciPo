...
- 内容规模：科技 **7/93** 节点（*v0.6.0 勘误：原文记 6/93，实为 7*）· 建筑 4/24 条 · 单位 3/5 类 · 事件 3/20 条 —— 填表债务（v0.6.0 起归 **§19 批次 7**：`WP-7.3` 科技 93 · `WP-7.2a/b` 建筑 24 · `WP-7.5` 单位 15 · `WP-7.4` 事件 20）
...
| WP-7.5 | 单位 15 个（玩家 10 + 敌方 5；HP/伤害/维护/掉落/标签） | ☐ 未开始 | M2 |
...
**进度**：批次 0~3 ✅（29 WP）· 批次 4 **4/19** · 批次 5 **6/11** · 批次 6 **6/6 ✅** · 批次 7 **2/7** · 批次 8 **0/4** → **已完成 47 / 剩余 29**（M2 剩 24 + M3 剩 5）。
