...
- 内容规模：科技 **7/93** 节点（*v0.6.0 勘误：原文记 6/93，实为 7*）· 建筑 4/24 条 · 单位 15/15 ✓（`WP-7.5`） · 事件 20/20 ✓（`WP-7.4`） —— 填表债务（v0.6.0 起归 **§19 批次 7**：`WP-7.3` 科技 93 · `WP-7.2a/b` 建筑 24 · `WP-7.5` 单位 15 · `WP-7.4` 事件 20）
