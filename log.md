...
| WP | 内容 | 状态 | M |
| :--- | :--- | :--- | :--- |
| WP-8.1 | 美术规格 + `AssetManifest` 定稿（尺寸/锚点/命名/授权来源） | ☐ 未开始 | M3 |
| WP-8.2 | 资源替换（按 Manifest 换图/换音，**不改代码** —— 由 `WP-5.3` 保证） | ☐ 未开始 | M3 |
...
**进度**：批次 0~3 ✅（29 WP）· 批次 4 **19/19 ✅** · 批次 5 **11/11 ✅** · 批次 6 **6/6 ✅** · 批次 7 **7/7 ✅** · 批次 8 **0/4** → **已完成 72 / 剩余 4**（**M2 全部完成 ✅**，剩 M3 的 4 个 + 等 N4 美术）。
