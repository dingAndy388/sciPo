...
### 批次 8 · 美术完工（4 WP · 完成 1 / 待美术 1 / 未开始 2）
...
| WP-8.4 | BGM + 打包（导出模板 + `*.json`/资源清单纳入导出） | ☐ 未开始 | M3 |
...
**进度**：批次 0~3 ✅（29 WP）· 批次 4 **19/19 ✅** · 批次 5 **11/11 ✅** · 批次 6 **6/6 ✅** · 批次 7 **7/7 ✅** · 批次 8 **1/4**（`8.1` ✅、`8.2` 接线完成等美术）→ **已完成 73 / 剩余 3**（**M2 全部完成 ✅**；剩 `WP-8.2` 收图 + `WP-8.3` 双语完工 + `WP-8.4` BGM/打包）。
